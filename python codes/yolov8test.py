...
model = YOLO("E:/Project/weights/2yolov8best.pt")
...
# cv2.imwrite('E:/Project/python codes/output images/modified_image6.jpg', img)

cv2.imwrite('E:/Project/frontend/public/images/YOLO8-'+filename+'.jpg', img)

# Display the image in fullscreen
# img_path = 'E:/Project/python codes/output images/modified_image6.jpg'
# display(Image(filename=img_path, width=1920, height=1080))
Image(filename=img_path)

print("test yolo v8 model")
