...
# model = YOLO("E:/Project/weights/yolov3best.pt")
...
# # cv2.imwrite('E:/Project/python codes/output images/modified_image1.jpg', img)

# cv2.imwrite('E:/Project/frontend/images/A-'+filename+'.jpg', img)

# Display the image in fullscreen
# img_path = 'E:/Project/python codes/output images/modified_image1.jpg'
...
cv2.imwrite('E:/Project/python codes/output images/modified_image2.jpg', img)

# Display the image in fullscreen
# img_path = 'E:/Project/python codes/output images/modified_image2.jpg'

cv2.imwrite('E:/Project/frontend/public/images/YOLO3-'+filename+'.jpg', img)
